/* ── Digital Marketing Agency — animations.js ── */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  intro.innerHTML = `
    <div style="text-align:center;">
      <div style="font-family:'Bebas Neue',sans-serif;font-size:3rem;letter-spacing:0.1em;color:#f5f0e8;opacity:0;transition:opacity 0.5s ease;" id="intro-logo">Digital Marketing Agency</div>
